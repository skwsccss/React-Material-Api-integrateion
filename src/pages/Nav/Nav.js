...
import  GuideSlider  from '../../Components/GuiSlider/index';
...
import styles from '../../assets/jss/appStyles-jss';
...
const NavMaped = connect(
    mapStateToProps,
    mapDispatchToProps
)(Nav);

export default (withStyles(styles)(NavMaped));
